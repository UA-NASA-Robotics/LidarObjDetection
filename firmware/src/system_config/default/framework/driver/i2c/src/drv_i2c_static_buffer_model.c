...
void DRV_I2C0_Initialize(void)
{
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_I2C1_MASTER, INT_PRIORITY_LEVEL4);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_I2C1_MASTER, INT_SUBPRIORITY_LEVEL1);
