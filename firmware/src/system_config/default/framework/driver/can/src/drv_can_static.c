...
void DRV_CAN0_Initialize(void)
{
    ...
    PLIB_CAN_ChannelForTransmitSet(CAN_ID_1, CAN_CHANNEL2, 32, CAN_TX_RTR_DISABLED, CAN_LOW_MEDIUM_PRIORITY);
    /* Configure CAN_ID_1 Channel for CAN_TX_RTR_DISABLED operation. Allocate 32 message buffer, and assign low medium priority for transmissions. */
    PLIB_CAN_ChannelForTransmitSet(CAN_ID_1, CAN_CHANNEL1, 32, CAN_TX_RTR_DISABLED, CAN_LOW_MEDIUM_PRIORITY);
    PLIB_CAN_FilterToChannelLink(CAN_ID_1, CAN_FILTER0, CAN_FILTER_MASK0, CAN_CHANNEL3);
    ...
    PLIB_CAN_FilterToChannelLink(CAN_ID_1, CAN_FILTER1, CAN_FILTER_MASK0, CAN_CHANNEL4);
    PLIB_CAN_ChannelEventEnable(CAN_ID_1, CAN_CHANNEL4, CAN_RX_CHANNEL_NOT_EMPTY);
    PLIB_CAN_FilterConfigure(CAN_ID_1, CAN_FILTER0, 0x300, CAN_SID);
    PLIB_CAN_FilterEnable(CAN_ID_1, CAN_FILTER0);
    PLIB_CAN_FilterConfigure(CAN_ID_1, CAN_FILTER1, 0x7C0, CAN_SID);
    PLIB_CAN_FilterEnable(CAN_ID_1, CAN_FILTER1);

    PLIB_CAN_FilterMaskConfigure(CAN_ID_1, CAN_FILTER_MASK0, 0x7E0, CAN_SID, CAN_FILTER_MASK_IDE_TYPE);
    ...
    PLIB_CAN_ModuleEventEnable(CAN_ID_1 , 0);
