...
// *********************************************************************************************
// *********************************************************************************************
// Section: Byte Model Client Interface Headers for the Instance 1 of USART static driver
// *********************************************************************************************
// *********************************************************************************************
...
// *********************************************************************************************
// *********************************************************************************************
// Section: Byte Model Client Interface Headers for the Instance 3 of USART static driver
// *********************************************************************************************
// *********************************************************************************************

uint8_t DRV_USART3_ReadByte( void);
void DRV_USART3_WriteByte( const uint8_t byte);
unsigned int DRV_USART3_ReceiverBufferSizeGet(void);
unsigned int DRV_USART3_TransmitBufferSizeGet(void);
bool DRV_USART3_ReceiverBufferIsEmpty( void );
bool DRV_USART3_TransmitBufferIsFull(void);
...
// *********************************************************************************************
// *********************************************************************************************
// Section: Byte Model Client Interface Headers for the Instance 4 of USART static driver
// *********************************************************************************************
// *********************************************************************************************

uint8_t DRV_USART4_ReadByte( void);
void DRV_USART4_WriteByte( const uint8_t byte);
unsigned int DRV_USART4_ReceiverBufferSizeGet(void);
unsigned int DRV_USART4_TransmitBufferSizeGet(void);
bool DRV_USART4_ReceiverBufferIsEmpty( void );
bool DRV_USART4_TransmitBufferIsFull(void);
