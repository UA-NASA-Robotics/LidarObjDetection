...
{   
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_2, 312);
    /* Setup Interrupt */   
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_T2, INT_PRIORITY_LEVEL6);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_T2, INT_SUBPRIORITY_LEVEL2);          
}
...
{   
    ...
    /* Select prescalar value */
    PLIB_TMR_PrescaleSelect(TMR_ID_4, TMR_PRESCALE_VALUE_2);
    /* Enable 16 bit mode */
    PLIB_TMR_Mode16BitEnable(TMR_ID_4);
    /* Clear counter */ 
    PLIB_TMR_Counter16BitClear(TMR_ID_4);
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_4, 3000);
    /* Setup Interrupt */   
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_T4, INT_DISABLE_INTERRUPT);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_T4, INT_SUBPRIORITY_LEVEL3);          
}
