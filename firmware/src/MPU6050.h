...
void calibrateGyro(MPU_6050_t *mpu,uint8_t samples); //default is 50
void setThreshold(MPU_6050_t *mpu,float multiple); //default is 1
float getThreshold(MPU_6050_t *mpu);

Vector readRawGyro(MPU_6050_t *mpu);
Vector readNormalizeGyro(MPU_6050_t *mpu);

Vector readRawAccel(MPU_6050_t *mpu);
...
void writeRegister16(MPU6050_ADDRESS address,uint8_t reg, int16_t value);
